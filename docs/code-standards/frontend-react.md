...
- `$env:BASE_URL = 'https://staging.example.com/app'; npx playwright test --debug`
- `$env:BASE_URL = 'https://localhost:5173/app'; npx playwright test caseDetails.spec.ts --headed --repeat-each 5`
- `$env:BASE_URL = 'https://localhost:5173/app'; $env:MODE = 'test'; npx playwright test caseDetails.spec.ts --headed --repeat-each 5`
