...
const enumFileIsolationRule = {
  meta: {
    ...
    messages: {
      multipleEnums:
        'Multiple exported enums in one file ({{enumNames}}). Separate files improve tree-shaking and make imports explicit. Give each enum its own file.',
      unrelatedExports:
        'Enum "{{enumName}}" shares a file with unrelated exports. This hurts tree-shaking and import clarity. Move to {{suggestedFile}} or move unrelated exports out.',
    },
  },
