  ...
  meta: {
    ...
    messages: {
      nonStandardPlaceholder:
        'Non-standard placeholder "{{placeholder}}". FM() requires standardized names — use {{p1}}/{{p2}}/{{p3}} for consistency across locales.',
      singleBracePlaceholder:
        'Single-brace placeholder "{{{placeholder}}}". i18next requires double braces — use {{{{{fixedName}}}}} for interpolation to work.',
      tooManyPlaceholders:
        'Translation has {{count}} placeholders but FM() supports max 3. Simplify the string or split into multiple translation keys.',
    },
  },
