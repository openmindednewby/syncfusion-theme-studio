  ...
  meta: {
    ...
    messages: {
      companionFileConflict:
        '"{{fileName}}" shadows barrel "{{barrelPath}}". TypeScript resolves `./{{baseName}}` to the file, not the barrel — exports from the barrel become invisible. Delete this file or replace with `export * from \'./{{baseName}}/index\';`.',
    },
  },
