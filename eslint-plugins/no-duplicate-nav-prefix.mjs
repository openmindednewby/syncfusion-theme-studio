...
const noDuplicateNavPrefixRule = {
  meta: {
    ...
    messages: {
      duplicatePrefix:
        'Duplicate pathPrefix "{{value}}". Multiple nav items will highlight simultaneously because NavExpandableItem uses startsWith(pathPrefix). Use a unique prefix for each item.',
    },
  },
