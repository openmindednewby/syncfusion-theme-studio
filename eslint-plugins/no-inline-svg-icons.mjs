...
const noInlineSvgIconsRule = {
  meta: {
    ...
    messages: {
      noInlineSvgIcon:
        'SVG icon "{{name}}" is defined outside icons/. Inline icons cause duplication and prevent code-splitting. Move to AppIcons.tsx, SettingsIcons.tsx, or ShowcaseIcons.tsx.',
    },
  },
