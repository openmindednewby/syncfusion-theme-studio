  ...
  rules: {
    'no-optional-undefined': {
      meta: {
        ...
        messages: {
          noOptionalUndefined:
            'Redundant `| undefined` on optional property. With exactOptionalPropertyTypes, `?:` already allows omission — use `?: {{type}}` and omit the key instead of assigning undefined.',
        },
        schema: [],
      },
      create(context) {
