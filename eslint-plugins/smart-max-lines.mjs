...
const smartMaxLinesRule = {
  meta: {
    ...
    messages: {
      componentTooLong:
        'React component has {{count}} lines (max {{max}}). Large components hurt readability and testability. Split into smaller sub-components.',
      functionTooLong:
        'Function has {{count}} lines (max {{max}}). Long functions are hard to test and review. Extract helpers or split responsibilities.',
      functionWarning:
        'Function is {{count}} lines (recommended max {{warn}}). Consider extracting logic into smaller, focused functions.',
    },
  },
