...
export default [
  ...
  // =====================================================
  {
    ignores: [
      ...
      'tmp/**', // Temporary visual-qa scripts
      'qa-test.mjs', // Visual QA test script
    ],
  },
  ...
  // =====================================================
  {
    ...
    rules: {
      ...
      // Prevent accidentally pulling the entire generated models barrel into the runtime graph.
      // Type-only imports are allowed; runtime imports must target leaf model modules.
      ...
      'require-stable-hook-args/require-stable-hook-args': [
        'warn',
        {
          ignoreHookPatterns: [
      ...
      'smart-max-lines/smart-max-lines': [
        'error',
        {
          componentMax: 200,
          functionMax: 50,
      ...
      'enforce-module-structure/enforce-module-structure': [
        'error',
        {
          fileThreshold: 4,
        },
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Use `const enum` instead of `enum`. Regular enums emit runtime objects that hurt tree-shaking — const enums are inlined at zero cost.',
        },
        {
          selector: 'IfStatement > LogicalExpression[left.type="LogicalExpression"]',
          message:
            'If-condition has 3+ boolean expressions. Complex conditions are hard to debug — extract to a named `const isX = ...` variable.',
        },
        {
        ...
        },
        {
          ...
          message:
            'Ternary condition has 3+ boolean expressions. Hard to read inline — extract to a named `const isX = ...` variable.',
        },
        {
        ...
        },
        {
          ...
          message:
            'While-condition has 3+ boolean expressions. Complex loop conditions cause subtle bugs — extract to a named `const isX = ...` variable.',
        },
        {
    ...
    rules: {
      'i18next/no-literal-string': [
        'error',
        {
          ...
          ignoreCallee: ['require', 'Error', 'URL', 'console.*', 'cn', 'navigate', 'useNavigate'],
          ignoreProperty: [
            'className',
            'style',
            'id',
  ...
  // =====================================================
  {
    ...
    rules: {
      'enforce-lazy-preload/enforce-lazy-preload': [
        'error',
        {
          ...
          patterns: [
            {
              ...
              message:
                'Import from barrel exports (@/components/ui/native, @/components/ui/syncfusion, @/components/ui/form-fields, or @/components/ui/shared) instead of directly from component folders.',
            },
          ],
        },
      ],
