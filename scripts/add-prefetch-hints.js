...
function inlineEntryCss(html, distDir) {
  ...
  // Do NOT delete the .css file. Lazy-loaded JS chunks still reference it
  // through Vite's __vite__mapDeps preload manifest — deleting the file
  // produced 404s on every navigation. Leaving it on disk costs a few KB of
  // image size but avoids the runtime errors. The render-blocking <link>
  // is already gone because we replaced it with the inline <style> above.
