...
export const PWAInstallPrompt = (): JSX.Element | null => {
  ...
  return (
    <div
      className="fixed bottom-4 left-4 z-50 flex max-w-sm flex-col gap-2 rounded-lg border border-border bg-surface-elevated p-4 shadow-lg"
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        <button
          className="rounded px-3 py-1 text-sm text-text-secondary hover:bg-surface-hover"
