...
export const ThemeStudioLogo = ({ className }: IconProps): JSX.Element => (
  <svg aria-hidden="true" className={className} fill="none" height="24" viewBox="0 0 24 24" width="24">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
    <path d="M22 12c0-5.52-4.48-10-10-10" stroke="url(#ts-grad)" strokeLinecap="round" strokeWidth="2" />
    <path d="M12 8a4 4 0 0 1 4 4" stroke="currentColor" strokeLinecap="round" strokeWidth="2" />
    <path d="M16 12a4 4 0 0 1-4 4" stroke="url(#ts-grad)" strokeLinecap="round" strokeWidth="2" />
    <defs>
      <linearGradient id="ts-grad" x1="8" x2="22" y1="2" y2="16">
