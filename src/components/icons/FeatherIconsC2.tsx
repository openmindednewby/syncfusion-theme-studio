/**
 * Auto-generated Feather icons (IconCodepen – IconCrosshair).
...
export const IconCodepen = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <path d="M12 2L22 8.5V15.5L12 22L2.00003 15.5V8.5L12 2Z" />
    <path d="M12 22V15.5" />
    <path d="M22 8.5L12 15.5L2.00003 8.5" />
    <path d="M2.00003 15.5L12 8.5L22 15.5" />
    <path d="M12 2V8.5" />
  </svg>
);

export const IconCodesandbox = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <path d="M21 16V8.00002C20.9996 7.6493 20.9071 7.30483 20.7315 7.00119C20.556 6.69754 20.3037 6.44539 20 6.27002L13 2.27002C12.696 2.09449 12.3511 2.00208 12 2.00208C11.6489 2.00208 11.304 2.09449 11 2.27002L4 6.27002C3.69626 6.44539 3.44398 6.69754 3.26846 7.00119C3.09294 7.30483 3.00036 7.6493 3 8.00002V16C3.00036 16.3508 3.09294 16.6952 3.26846 16.9989C3.44398 17.3025 3.69626 17.5547 4 17.73L11 21.73C11.304 21.9056 11.6489 21.998 12 21.998C12.3511 21.998 12.696 21.9056 13 21.73L20 17.73C20.3037 17.5547 20.556 17.3025 20.7315 16.9989C20.9071 16.6952 20.9996 16.3508 21 16Z" />
    <path d="M7.5 4.20996L12 6.80996L16.5 4.20996" />
    <path d="M7.5 19.79V14.6L3 12" />
    <path d="M21 12L16.5 14.6V19.79" />
    <path d="M3.27002 6.95996L12 12.01L20.73 6.95996" />
    <path d="M12 22.08V12" />
  </svg>
);

export const IconCoffee = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconColumns = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCommand = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCompass = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCopy = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCornerDownLeft = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <path d="M8.99998 10L3.99998 15L8.99998 20" />
    <path d="M20 4V11C20 12.0609 19.5786 13.0783 18.8284 13.8284C18.0783 14.5786 17.0608 15 16 15H3.99998" />
  </svg>
);

export const IconCornerDownRight = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <path d="M15 10L20 15L15 20" />
    <path d="M3.99997 4V11C3.99997 12.0609 4.4214 13.0783 5.17154 13.8284C5.92169 14.5786 6.9391 15 7.99997 15H20" />
  </svg>
);

export const IconCornerLeftDown = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <path d="M14 15L8.99997 20L3.99997 15" />
    <path d="M20 4H13C11.9391 4 10.9217 4.42143 10.1716 5.17157C9.42143 5.92172 9 6.93913 9 8V20" />
  </svg>
);

export const IconCornerLeftUp = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCornerRightDown = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCornerRightUp = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCornerUpLeft = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCornerUpRight = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
...
export const IconCpu = ({ className }: IconProps): JSX.Element => (
  <svg {...defaults} className={className}>
    <g clipPath="url(#clip0_2868_1989)">
