...
export const DragHandleIcon = (): JSX.Element => (
  <svg fill="currentColor" height="14" viewBox="0 0 10 14" width="10">
...
export const KebabIcon = (): JSX.Element => (
  <svg fill="currentColor" height="10" viewBox="0 0 2 10" width="2">
    <rect height="2" width="2" x="0" y="0" />
    <rect height="2" width="2" x="0" y="4" />
    <rect height="2" width="2" x="0" y="8" />
  </svg>
);
