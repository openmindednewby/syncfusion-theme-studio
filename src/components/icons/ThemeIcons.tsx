/**
 * Theme toggle icons (moon/sun) used in the header theme switcher.
 */
import type { IconProps } from './types';

export const ThemeMoonIcon = ({ className }: IconProps): JSX.Element => (
  <svg aria-hidden="true" className={className ?? 'h-5 w-5'} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const ThemeSunIcon = ({ className }: IconProps): JSX.Element => (
  <svg aria-hidden="true" className={className ?? 'h-5 w-5'} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
