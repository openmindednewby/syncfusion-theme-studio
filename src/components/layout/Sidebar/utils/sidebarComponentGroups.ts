...
export const COMPONENTS_CHILDREN: NavChild[] = [
  ...
  { path: RoutePath.ComponentsImageNative, labelKey: 'menu.image', testId: ComponentTestIds.NAV_IMAGE_GROUP },
  {
  ...
  { path: RoutePath.ComponentsColorsNative, labelKey: 'menu.colors', testId: ComponentTestIds.NAV_COLORS_GROUP },
  { path: RoutePath.ComponentsIconsNative, labelKey: 'menu.icons', testId: ComponentTestIds.NAV_ICONS_GROUP },
  {
    ...
    expandTestId: ComponentTestIds.NAV_GRID_GROUP_EXPAND, items: [
      ...
      { path: RoutePath.ComponentsGridPlayground, labelKey: 'menu.playground', testId: ComponentTestIds.NAV_GRID_PLAYGROUND },
    ],
  },
  {
  ...
  { path: RoutePath.ComponentsLoaderNative, labelKey: 'menu.loader', testId: ComponentTestIds.NAV_LOADER_GROUP },
  { path: RoutePath.ComponentsSliderNative, labelKey: 'menu.slider', testId: ComponentTestIds.NAV_SLIDER_GROUP },
  { path: RoutePath.ComponentsSkeletonLoaderNative, labelKey: 'menu.skeletonLoader', testId: ComponentTestIds.NAV_SKELETONLOADER_GROUP },
  { path: RoutePath.ComponentsNavMenuNative, labelKey: 'menu.navMenu', testId: ComponentTestIds.NAV_NAVMENU_GROUP },
  { path: RoutePath.ComponentsPaginationNative, labelKey: 'menu.pagination', testId: ComponentTestIds.NAV_PAGINATION_GROUP },
  { path: RoutePath.ComponentsPillBadgeNative, labelKey: 'menu.pillBadge', testId: ComponentTestIds.NAV_PILLBADGE_GROUP },
  { path: RoutePath.ComponentsSearchPanelNative, labelKey: 'menu.searchPanel', testId: ComponentTestIds.NAV_SEARCHPANEL_GROUP },
  ...
  { path: RoutePath.ComponentsTypographyNative, labelKey: 'menu.typography', testId: ComponentTestIds.NAV_TYPOGRAPHY_GROUP },
  {
