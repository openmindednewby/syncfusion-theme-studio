...
const TRANSFORM_OPTIONS = [
  { value: 'none', labelKey: 'themeSettings.components.dataGrid.transformNone' },
  { value: 'uppercase', labelKey: 'themeSettings.components.dataGrid.transformUppercase' },
  { value: 'lowercase', labelKey: 'themeSettings.components.dataGrid.transformLowercase' },
  { value: 'capitalize', labelKey: 'themeSettings.components.dataGrid.transformCapitalize' },
] as const;

const WEIGHT_OPTIONS = [
  { value: '400', labelKey: 'themeSettings.components.dataGrid.weight400' },
  { value: '500', labelKey: 'themeSettings.components.dataGrid.weight500' },
  { value: '600', labelKey: 'themeSettings.components.dataGrid.weight600' },
  { value: '700', labelKey: 'themeSettings.components.dataGrid.weight700' },
] as const;
