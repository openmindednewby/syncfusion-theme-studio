...
const ButtonFields = ({ config, onUpdate }: PaginationEditorProps): JSX.Element => (
  <>
    ...
    />
    <ColorPicker
      label={FM('themeSettings.components.pagination.buttonBorderColor')}
      value={config.buttonBorderColor}
      onChange={(value) => onUpdate({ buttonBorderColor: value })}
    />
    <TextInputRow
      label={FM('themeSettings.components.pagination.buttonBorderWidth')}
      value={config.buttonBorderWidth}
      onChange={(value) => onUpdate({ buttonBorderWidth: value })}
    />
    <TextInputRow
      label={FM('themeSettings.components.pagination.buttonFontSize')}
      value={config.buttonFontSize}
      onChange={(value) => onUpdate({ buttonFontSize: value })}
    />
    <TextInputRow
      label={FM('themeSettings.components.pagination.buttonSize')}
...
const PAGINATION_PROPERTY_COUNT = 20;
