  ...
  <CollapsibleSection title={FM('themeSettings.components.sidebar.title')}>
    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2 pl-2">
        ...
        />
        <SidebarTextField
          label={FM('themeSettings.components.sidebar.fontFamily')}
          placeholder="inherit"
    ...
    {/* Item Layout Subsection */}
    <div className="space-y-2">
      <p className="text-xs font-medium text-text-secondary">
        {FM('themeSettings.components.sidebar.itemLayoutTitle')}
      </p>
      <div className="space-y-2 pl-2">
        <SidebarTextField
          label={FM('themeSettings.components.sidebar.itemBorderRadius')}
          placeholder="6px"
          value={config.itemBorderRadius}
          onChange={(value) => onUpdate({ itemBorderRadius: value })}
        />
        <SidebarTextField
          label={FM('themeSettings.components.sidebar.menuButtonPaddingLeft')}
          placeholder="8px"
          value={config.menuButtonPaddingLeft}
          onChange={(value) => onUpdate({ menuButtonPaddingLeft: value })}
        />
      </div>
    </div>
