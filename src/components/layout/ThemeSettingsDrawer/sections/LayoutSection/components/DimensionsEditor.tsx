    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2">
        <TextInputRow
          ...
          placeholder={FM('themeSettings.layout.placeholders.sidebarWidth')}
          value={layout.sidebarWidth}
          onChange={(value) => onLayoutChange('sidebarWidth', value)}
        />
        <TextInputRow
          label={FM('themeSettings.layout.sidebarCollapsed')}
          placeholder={FM('themeSettings.layout.placeholders.sidebarCollapsed')}
        ...
        <TextInputRow
          ...
          placeholder={FM('themeSettings.layout.placeholders.headerHeight')}
        ...
        {!layout.contentFullWidth && (
          <TextInputRow
            ...
            placeholder={FM('themeSettings.layout.placeholders.contentMaxWidth')}
        ...
        <NumberInputRow
          ...
          min={1}
          step={1}
          suffix={FM('themeSettings.layout.spacingSuffix')}
