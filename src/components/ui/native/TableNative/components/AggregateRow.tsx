  ...
  return (
    <tr
      ...
      style={{
        ...
        borderTopWidth: 'var(--component-datagrid-footer-border-width)',
      }}
    >
      ...
      {columns.map((col) => {
        ...
        return (
          <td
            ...
            style={{
              padding: 'var(--component-datagrid-footer-padding)',
              color: 'var(--component-datagrid-footer-text)',
              fontSize: 'var(--component-datagrid-footer-font-size)',
              fontWeight: 'var(--component-datagrid-footer-font-weight)',
            }}
          >
            {agg?.formatted ?? ''}
          </td>
