 ...
 * and configuration.
 */
import type { FilterSettingsModel, PageSettingsModel } from '@syncfusion/ej2-react-grids';
...
/** z-index for the column chooser dialog. */
export const COLUMN_CHOOSER_Z_INDEX = '100000';
...
/** Default filter settings — Menu type so filter is only accessible through the column menu. */
export const DEFAULT_FILTER_SETTINGS: FilterSettingsModel = {
  type: 'Menu',
};
