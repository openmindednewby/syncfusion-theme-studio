...
function resolveCoreFeatures<T extends object>(
  ...
  return {
    ...
    filtering: resolveBoolean(props.allowFiltering, config?.filter?.enabled, true),
...
function resolveColumnFeatures<T extends object>(
  ...
  return {
    resizing: resolveBoolean(props.allowResizing, undefined, true),
    reordering: resolveBoolean(props.allowReordering, undefined, true),
    freezing: hasFreezing(props),
    columnChooser: resolveBoolean(props.showColumnChooser, config?.columnChooser?.enabled, true),
    columnMenu: resolveBoolean(props.showColumnMenu, config?.columnMenu?.enabled, true),
