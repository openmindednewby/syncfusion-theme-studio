...
export interface DataGridProps<T extends object> {
  ...
  frozenRows?: number;
  /** Show column chooser dialog (default: true) */
  showColumnChooser?: boolean;
  /** Show column-level menu (default: true) */
  ...
  /** Grid density level — controls row height via scoped CSS variables */
  density?: GridDensity;
  /** Partial DataGridConfig overrides applied as scoped CSS variables */
