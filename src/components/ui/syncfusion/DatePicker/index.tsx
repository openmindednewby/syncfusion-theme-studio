...
interface Props extends Omit<DatePickerModel, 'cssClass' | 'floatLabelType' | 'value'> {
  // eslint-disable-next-line no-optional-undefined/no-optional-undefined -- exactOptionalPropertyTypes requires explicit undefined for conditional spread in FormDatePicker
