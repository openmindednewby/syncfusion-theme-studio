 ...
 * Contains search input, filter toggle, date range picker, and action icons.
 */
import { memo } from 'react';

import { IconDownload, IconFilter, IconRefreshLast24, IconSearch, IconSettings } from '@/components/icons';
import {
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <DateRangePickerNative
          ...
          endDate={endDate}
          startDate={startDate}
          testId={TestIds.ALERT_TOOLBAR_DATE_RANGE}
