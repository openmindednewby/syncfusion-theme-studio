  ...
  <div className="h-full overflow-y-auto p-6" data-testid={TestIds.ALERT_BADGE_SHOWCASE}>
    <div className="space-y-8">
      ...
      <section className="card space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          <AlertBadge appearance={AlertBadgeAppearance.Outline} testId="alert-badge-sla-breached" text="Overdue" variant={BadgeVariant.Error} />
          <AlertBadge appearance={AlertBadgeAppearance.Outline} testId="alert-badge-sla-risk" text="Delayed" variant={BadgeVariant.Warning} />
          <AlertBadge appearance={AlertBadgeAppearance.Outline} testId="alert-badge-sla-ok" text="On Schedule" variant={BadgeVariant.Success} />
        </div>
        <CopyableCodeSnippet code='<AlertBadge appearance={AlertBadgeAppearance.Outline} text="Overdue" variant={BadgeVariant.Error} />' />
      </section>
      <section className="card space-y-4">
