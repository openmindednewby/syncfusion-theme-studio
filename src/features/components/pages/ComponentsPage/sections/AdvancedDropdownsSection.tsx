      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-2">
          ...
          <ComboBoxComponent
            ...
            id={comboId}
            placeholder={FM('components.placeholders.selectOrTypeCountry')}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <AutoCompleteComponent
            ...
            id={autoCompleteId}
            placeholder={FM('components.placeholders.searchReactTopics')}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <MultiSelectComponent
            ...
            id={multiSelectId}
            mode="Box"
            placeholder={FM('components.placeholders.selectSkills')}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <ComboBoxComponent
            ...
            fields={{ value: 'id', text: 'text' }}
            id={comboErrorId}
            placeholder={FM('components.placeholders.requiredField')}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <AutoCompleteComponent
            ...
            placeholder={FM('common.disabled')}
        ...
        <div className="space-y-2">
          ...
          <MultiSelectComponent
            ...
            mode="Default"
            placeholder={FM('components.placeholders.selectTechnologies')}
