          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <NumericTextBoxComponent
                ...
                max={NUMERIC_MAX}
                min={NUMERIC_MIN}
                placeholder={FM('components.placeholders.enterNumber')}
            ...
            <div className="space-y-2">
              ...
              <NumericTextBoxComponent
                ...
                max={NUMERIC_MAX}
                min={NUMERIC_MIN}
                placeholder={FM('components.placeholders.enterAmount')}
                value={NUMERIC_DEFAULT_VALUE}
              />
            </div>
            <div className="space-y-2">
              ...
              <NumericTextBoxComponent
                ...
                max={PERCENTAGE_MAX}
                min={PERCENTAGE_MIN}
                placeholder={FM('components.placeholders.enterPercentage')}
