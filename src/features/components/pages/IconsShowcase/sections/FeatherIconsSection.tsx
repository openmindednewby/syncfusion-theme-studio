...
const FeatherIconsSection = (): JSX.Element => (
  <section className="card space-y-4">
    <h3 className="text-lg font-semibold text-text-primary">
      {FM('components.iconsShowcase.featherIcons')}
    </h3>
    <p className="text-sm text-text-secondary">
      {FM('components.iconsShowcase.featherIconsDescription')}
    </p>
    <div className="grid grid-cols-2 gap-1 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8">
      {FEATHER_ICON_ENTRIES.map((entry) => (
