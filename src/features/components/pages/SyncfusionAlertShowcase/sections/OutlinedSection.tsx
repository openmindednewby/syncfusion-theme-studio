/**
 * OutlinedSection - Demonstrates Syncfusion Message/Alert with outlined (border-only)
...
export const OutlinedSection = memo((): JSX.Element => {
    ...
    <section className="card space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-text-primary">
          {FM('components.alertShowcase.sections.outlined')}
        </h3>
        <p className="mt-1 text-sm text-text-secondary">
          {FM('components.alertShowcase.sections.outlinedDesc')}
        </p>
      </div>
...
OutlinedSection.displayName = 'OutlinedSection';
