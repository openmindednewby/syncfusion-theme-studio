  ...
  <section className="card space-y-4" data-testid="sf-breadcrumb-custom">
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <BreadcrumbComponent enableNavigation={false} overflowMode="None" separatorTemplate="&gt;">
          <BreadcrumbItemsDirective>
      ...
      <div className="space-y-2">
        ...
        <BreadcrumbComponent enableNavigation={false} overflowMode="None" separatorTemplate={dotSeparator}>
          <BreadcrumbItemsDirective>
