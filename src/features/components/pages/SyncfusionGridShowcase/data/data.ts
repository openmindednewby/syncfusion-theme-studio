...
export const COL_WIDTH_ACTIONS = 180;
...
export const EMPLOYEES: Employee[] = [
  ...
  { id: 11, name: 'Lena Novak', email: 'lena@co.com', role: 'Lead', status: 'Active', department: 'Engineering', salary: 102000, hireDate: '2018-04-12', country: 'Germany' },
  { id: 12, name: 'Mike Patel', email: 'mike@co.com', role: 'QA', status: 'Active', department: 'Engineering', salary: 74000, hireDate: '2022-07-08', country: 'UK' },
  { id: 13, name: 'Nina Rossi', email: 'nina@co.com', role: 'Designer', status: 'On Leave', department: 'Design', salary: 80000, hireDate: '2020-01-20', country: 'USA' },
  { id: 14, name: 'Oscar Tanaka', email: 'oscar@co.com', role: 'Analyst', status: 'Active', department: 'Analytics', salary: 76000, hireDate: '2021-03-15', country: 'Japan' },
  { id: 15, name: 'Priya Sharma', email: 'priya@co.com', role: 'Developer', status: 'Active', department: 'Engineering', salary: 89000, hireDate: '2019-09-01', country: 'Canada' },
  { id: 16, name: 'Quinn Murphy', email: 'quinn@co.com', role: 'Manager', status: 'Active', department: 'Marketing', salary: 96000, hireDate: '2017-11-22', country: 'Australia' },
  { id: 17, name: 'Ravi Gupta', email: 'ravi@co.com', role: 'Developer', status: 'Inactive', department: 'Engineering', salary: 84000, hireDate: '2020-06-30', country: 'USA' },
  { id: 18, name: 'Sofia Lund', email: 'sofia@co.com', role: 'Lead', status: 'Active', department: 'Design', salary: 99000, hireDate: '2018-08-17', country: 'Germany' },
  { id: 19, name: 'Tom Walker', email: 'tom@co.com', role: 'QA', status: 'Active', department: 'Engineering', salary: 71000, hireDate: '2023-02-28', country: 'UK' },
  { id: 20, name: 'Uma Ali', email: 'uma@co.com', role: 'Analyst', status: 'On Leave', department: 'Analytics', salary: 73000, hireDate: '2021-12-05', country: 'Canada' },
  { id: 21, name: 'Victor Song', email: 'victor@co.com', role: 'Developer', status: 'Active', department: 'Engineering', salary: 87000, hireDate: '2020-10-14', country: 'USA' },
  { id: 22, name: 'Wendy Park', email: 'wendy@co.com', role: 'Designer', status: 'Active', department: 'Design', salary: 79000, hireDate: '2022-05-19', country: 'Japan' },
  { id: 23, name: 'Xavier Cruz', email: 'xavier@co.com', role: 'Manager', status: 'Active', department: 'Sales', salary: 97000, hireDate: '2019-01-07', country: 'Australia' },
  { id: 24, name: 'Yara Osman', email: 'yara@co.com', role: 'Lead', status: 'Active', department: 'Support', salary: 93000, hireDate: '2018-03-25', country: 'Germany' },
  { id: 25, name: 'Zane Brooks', email: 'zane@co.com', role: 'QA', status: 'Inactive', department: 'Engineering', salary: 72000, hireDate: '2023-06-10', country: 'USA' },
];
