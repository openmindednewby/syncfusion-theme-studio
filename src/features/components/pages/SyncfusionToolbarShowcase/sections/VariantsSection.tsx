    ...
    <section className="card space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <ToolbarComponent overflowMode="Scrollable" width="400px">
            <ItemsDirective>
        ...
        <div>
          ...
          <ToolbarComponent overflowMode="Popup" width="500px">
            <ItemsDirective>
              <ItemDirective overflow="Show" prefixIcon="e-icons e-cut" text={FM('components.nativeToolbar.cut')} tooltipText={FM('components.nativeToolbar.cut')} />
              <ItemDirective overflow="Show" prefixIcon="e-icons e-copy" text={FM('components.nativeToolbar.copy')} tooltipText={FM('components.nativeToolbar.copy')} />
              <ItemDirective overflow="Show" prefixIcon="e-icons e-paste" text={FM('components.nativeToolbar.paste')} tooltipText={FM('components.nativeToolbar.paste')} />
              <ItemDirective type="Separator" />
              <ItemDirective prefixIcon="e-icons e-bold" text={FM('components.nativeToolbar.bold')} tooltipText={FM('components.nativeToolbar.bold')} />
              <ItemDirective prefixIcon="e-icons e-italic" text={FM('components.nativeToolbar.italic')} tooltipText={FM('components.nativeToolbar.italic')} />
              <ItemDirective prefixIcon="e-icons e-underline" text={FM('components.nativeToolbar.underline')} tooltipText={FM('components.nativeToolbar.underline')} />
      ...
      <CopyableCodeSnippet code='<ToolbarComponent overflowMode="Popup" width="500px"><ItemDirective overflow="Show" text="Cut" />...</ToolbarComponent>' />
    </section>
  );
});
