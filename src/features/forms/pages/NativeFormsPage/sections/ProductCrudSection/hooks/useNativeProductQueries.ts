/**
 * useNativeProductQueries - Fetches products list and categories from the API.
 */
...
export interface NativeProductQueryResult {
  products: ProductDto[];
...
export function useNativeProductQueries(): NativeProductQueryResult {
