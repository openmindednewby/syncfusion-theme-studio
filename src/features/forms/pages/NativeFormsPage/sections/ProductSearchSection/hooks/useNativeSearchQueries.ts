/**
 * useNativeSearchQueries - Executes the appropriate API queries based on search mode.
 */
...
export function useNativeSearchQueries(input: SearchQueryInput): SearchQueryResult {
