/* eslint-disable max-lines -- Pure test ID constants that grow with each new component */
...
export const ComponentTestIds = {
  ...
  NAV_GRID_PLAYGROUND: 'nav-grid-playground',
  ...
  NATIVE_LOADER_SHOWCASE: 'native-loader-showcase',
  NATIVE_SLIDER_SHOWCASE: 'native-slider-showcase',
  NATIVE_SKELETONLOADER_SHOWCASE: 'native-skeletonloader-showcase',
  NATIVE_THEMETOGGLE_SHOWCASE: 'native-themetoggle-showcase',
  NATIVE_TYPOGRAPHY_SHOWCASE: 'native-typography-showcase',
  COLORS_SHOWCASE: 'colors-showcase',
  ...
  NAV_TYPOGRAPHY_GROUP: 'nav-typography-group',
  NAV_COLORS_GROUP: 'nav-colors-group',
  NAV_ICONS_GROUP: 'nav-icons-group',
  NAV_LOADER_GROUP: 'nav-loader-group',
  NAV_SLIDER_GROUP: 'nav-slider-group',
  NAV_SKELETONLOADER_GROUP: 'nav-skeletonloader-group',
  ...
  NATIVE_GRID_BUTTON_SECTION: 'native-grid-button-section',
  ...
  NAV_IMAGE_GROUP: 'nav-image-group',

  // Alert Badge
  ALERT_BADGE: 'alert-badge',

  // Pill Badge
  PILL_BADGE_SHOWCASE: 'pill-badge-showcase',
  NAV_PILLBADGE_GROUP: 'nav-pillbadge-group',

  // Pagination
  PAGINATION_SHOWCASE: 'pagination-showcase',
  NAV_PAGINATION_GROUP: 'nav-pagination-group',

  // Search Panel
  SEARCH_PANEL_SHOWCASE: 'search-panel-showcase',
  NAV_SEARCHPANEL_GROUP: 'nav-searchpanel-group',
  SEARCH_PANEL: 'search-panel',
  SEARCH_PANEL_COLUMN: 'search-panel-column',
  SEARCH_PANEL_INPUT: 'search-panel-input',
  SEARCH_PANEL_TOGGLE: 'search-panel-toggle',
  SEARCH_PANEL_REFRESH: 'search-panel-refresh',
  SEARCH_PANEL_DATE_RANGE: 'search-panel-daterange',
  SEARCH_PANEL_DOWNLOAD: 'search-panel-download',
  SEARCH_PANEL_ACTIONS: 'search-panel-actions',
  SEARCH_PANEL_INTERACTIVE: 'search-panel-interactive',
  SEARCH_PANEL_INTERACTIVE_STATE: 'search-panel-interactive-state',
  SEARCH_PANEL_LEFT_SLOT: 'search-panel-left-slot',
  SEARCH_PANEL_RIGHT_SLOT: 'search-panel-right-slot',
  SEARCH_PANEL_FULLY_CUSTOM: 'search-panel-fully-custom',
  SEARCH_PANEL_FULLY_CUSTOM_STATE: 'search-panel-fully-custom-state',
