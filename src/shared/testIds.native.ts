/** Native component-specific test IDs (sections, elements, interactions). */
export const NativeTestIds = {
  // Toast sections
  ...
  NATIVE_BREADCRUMB_COLLAPSED: 'native-breadcrumb-collapsed',
  ...
  // Grid Dropdown
  NATIVE_GRID_DROPDOWN_SECTION: 'native-grid-dropdown-section',
  NATIVE_GRID_DROPDOWN_TRIGGER: 'native-grid-dropdown-trigger',
  NATIVE_GRID_DROPDOWN_POPUP: 'native-grid-dropdown-popup',
  NATIVE_GRID_DROPDOWN_ITEM: 'native-grid-dropdown-item',
} as const;
