...
export interface ComponentConfigActions {
  ...
  updatePillBadgeConfig: ThemeState['updatePillBadgeConfig'];
  ...
  updateGridButtonsConfig: ThemeState['updateGridButtonsConfig'];
  updateGridButtonVariant: ThemeState['updateGridButtonVariant'];
  updateGridDropdownConfig: ThemeState['updateGridDropdownConfig'];
  ...
  updateImageConfig: ThemeState['updateImageConfig'];
  updateInputMessageConfig: ThemeState['updateInputMessageConfig'];
  updateSearchPanelConfig: ThemeState['updateSearchPanelConfig'];
  updateLoaderConfig: ThemeState['updateLoaderConfig'];
  updateSkeletonLoaderConfig: ThemeState['updateSkeletonLoaderConfig'];
  updateSliderConfig: ThemeState['updateSliderConfig'];
}
