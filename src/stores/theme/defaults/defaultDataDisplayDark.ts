...
export const DEFAULT_DATA_DISPLAY_DARK: Pick<ComponentConfigSingle, DataDisplayKeysType> = {
  ...
  slider: {
    trackBg: '55 65 81',
    fillColor: '96 165 250',
    thumbColor: '96 165 250',
    thumbHoverColor: '147 197 253',
    thumbActiveColor: '191 219 254',
    focusRingColor: '96 165 250',
    tickColor: '156 163 175',
    tooltipBg: '96 165 250',
    tooltipText: '17 24 39',
    disabledOpacity: '0.5',
  },
};
