...
import { DATE_PICKER_LIGHT } from './datePickerDefaults';

import type { FeedbackKeys } from './defaultKeys';

export const DEFAULT_FEEDBACK_LIGHT: Pick<ComponentConfigSingle, `${FeedbackKeys}`> = {
  select: {
    ...
    popupBorderColor: '209 213 219',
    itemHoverBackground: '243 244 246',
