...
export function injectTextDescriptionVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  ...
  root.style.setProperty('--component-text-description-see-more-color', `rgb(${textDescription.seeMoreTextColor})`);
  root.style.setProperty('--component-text-description-see-more-font-size', textDescription.seeMoreFontSize);
  root.style.setProperty('--component-text-description-see-more-font-weight', textDescription.seeMoreFontWeight);
  root.style.setProperty('--component-text-description-see-more-line-height', textDescription.seeMoreLineHeight);
  root.style.setProperty('--component-text-description-see-more-height', textDescription.seeMoreHeight);
  root.style.setProperty('--component-text-description-see-more-padding-top', textDescription.seeMorePadding.paddingTop);
  root.style.setProperty('--component-text-description-see-more-padding-right', textDescription.seeMorePadding.paddingRight);
  root.style.setProperty('--component-text-description-see-more-padding-bottom', textDescription.seeMorePadding.paddingBottom);
  root.style.setProperty('--component-text-description-see-more-padding-left', textDescription.seeMorePadding.paddingLeft);
  root.style.setProperty('--component-text-description-see-more-margin-top', textDescription.seeMoreMargin.marginTop);
  root.style.setProperty('--component-text-description-see-more-margin-right', textDescription.seeMoreMargin.marginRight);
  root.style.setProperty('--component-text-description-see-more-margin-bottom', textDescription.seeMoreMargin.marginBottom);
  root.style.setProperty('--component-text-description-see-more-margin-left', textDescription.seeMoreMargin.marginLeft);
}
...
export function injectImageVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  const { image } = c;
  root.style.setProperty('--component-image-bg', `rgb(${image.background})`);
  root.style.setProperty('--component-image-border', `rgb(${image.borderColor})`);
  root.style.setProperty('--component-image-border-radius', image.borderRadius);
  root.style.setProperty('--component-image-placeholder-icon', `rgb(${image.placeholderIconColor})`);
  root.style.setProperty('--component-image-hover-border', `rgb(${image.hoverBorderColor})`);
  root.style.setProperty('--component-image-shadow', image.shadowDefault);
  root.style.setProperty('--component-image-shadow-hover', image.shadowHover);
  root.style.setProperty('--component-image-object-fit', image.objectFit);
  root.style.setProperty('--component-image-transition', image.transitionDuration);
}

export function injectSearchPanelVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  const { searchPanel } = c;
  root.style.setProperty('--component-search-panel-bg', `rgb(${searchPanel.background})`);
  root.style.setProperty('--component-search-panel-border', `rgb(${searchPanel.borderColor})`);
  root.style.setProperty('--component-search-panel-gap', searchPanel.gap);
  root.style.setProperty('--component-search-panel-padding', searchPanel.padding);
  root.style.setProperty('--component-search-panel-filter-row-gap', searchPanel.filterRowGap);
  root.style.setProperty('--component-search-panel-label', `rgb(${searchPanel.labelColor})`);
  root.style.setProperty('--component-search-panel-label-font-size', searchPanel.labelFontSize);
  root.style.setProperty('--component-search-panel-search-width', searchPanel.searchWidth);
  root.style.setProperty('--component-search-panel-filter-width', searchPanel.filterWidth);
  root.style.setProperty('--component-search-panel-border-radius', searchPanel.borderRadius);
  root.style.setProperty('--component-search-panel-label-font-weight', searchPanel.labelFontWeight);
}

export function injectLoaderVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  root.style.setProperty('--component-loader-color', `rgb(${c.loader.spinnerColor})`);
  root.style.setProperty('--component-loader-track', `rgb(${c.loader.trackColor})`);
  root.style.setProperty('--component-loader-size', c.loader.size);
  root.style.setProperty('--component-loader-border-width', c.loader.borderWidth);
  root.style.setProperty('--component-loader-duration', c.loader.animationDuration);
  root.style.setProperty('--component-loader-icon-color', `rgb(${c.loader.iconColor})`);
  root.style.setProperty('--component-loader-icon-size', c.loader.iconSize);
}

export function injectSkeletonLoaderVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  root.style.setProperty('--component-skeleton-base', `rgb(${c.skeletonLoader.baseColor})`);
  root.style.setProperty('--component-skeleton-shimmer', `rgb(${c.skeletonLoader.shimmerColor})`);
  root.style.setProperty('--component-skeleton-radius', c.skeletonLoader.borderRadius);
  root.style.setProperty('--component-skeleton-duration', c.skeletonLoader.animationDuration);
}

export function injectSliderVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  root.style.setProperty('--component-slider-track', `rgb(${c.slider.trackBg})`);
  root.style.setProperty('--component-slider-fill', `rgb(${c.slider.fillColor})`);
  root.style.setProperty('--component-slider-thumb', `rgb(${c.slider.thumbColor})`);
  root.style.setProperty('--component-slider-thumb-hover', `rgb(${c.slider.thumbHoverColor})`);
  root.style.setProperty('--component-slider-thumb-active', `rgb(${c.slider.thumbActiveColor})`);
  root.style.setProperty('--component-slider-focus-ring', `rgb(${c.slider.focusRingColor})`);
  root.style.setProperty('--component-slider-tick', `rgb(${c.slider.tickColor})`);
  root.style.setProperty('--component-slider-tooltip-bg', `rgb(${c.slider.tooltipBg})`);
  root.style.setProperty('--component-slider-tooltip-text', `rgb(${c.slider.tooltipText})`);
  root.style.setProperty('--component-slider-disabled-opacity', c.slider.disabledOpacity);
}
