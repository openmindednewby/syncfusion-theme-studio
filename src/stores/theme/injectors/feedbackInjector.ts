...
export function injectSelectVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  injectSelectBaseVariables(root, c);
  injectSelectComboboxVariables(root, c);
}

export { injectDatePickerVariables } from './datePickerInjector';
...
export function injectChipVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  ...
  root.style.setProperty('--component-chip-border-radius', /^\d/.test(c.chips.borderRadius) ? c.chips.borderRadius : `var(--radius-${c.chips.borderRadius})`);
...
export function injectInputMessageVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  const { inputMessage } = c;
  root.style.setProperty('--component-input-msg-text', `rgb(${inputMessage.textColor})`);
  root.style.setProperty('--component-input-msg-idle-icon', `rgb(${inputMessage.idleIconColor})`);
  root.style.setProperty('--component-input-msg-valid-icon', `rgb(${inputMessage.validIconColor})`);
  root.style.setProperty('--component-input-msg-invalid-icon', `rgb(${inputMessage.invalidIconColor})`);
  root.style.setProperty('--component-input-msg-font-family', inputMessage.fontFamily);
  root.style.setProperty('--component-input-msg-font-weight', inputMessage.fontWeight);
  root.style.setProperty('--component-input-msg-font-size-s', inputMessage.fontSizeS);
  root.style.setProperty('--component-input-msg-line-height-s', inputMessage.lineHeightS);
  root.style.setProperty('--component-input-msg-font-size-m', inputMessage.fontSizeM);
  root.style.setProperty('--component-input-msg-line-height-m', inputMessage.lineHeightM);
  root.style.setProperty('--component-input-msg-font-size-l', inputMessage.fontSizeL);
  root.style.setProperty('--component-input-msg-line-height-l', inputMessage.lineHeightL);
  root.style.setProperty('--component-input-msg-gap', inputMessage.gap);
  root.style.setProperty('--component-input-msg-spacing-top', inputMessage.spacingTop);
  root.style.setProperty('--component-input-msg-icon-size', inputMessage.iconSize);
}
...
function injectSelectBaseVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  ...
  root.style.setProperty('--component-select-border-radius', /^\d/.test(c.select.borderRadius) ? c.select.borderRadius : `var(--radius-${c.select.borderRadius})`);
  ...
  root.style.setProperty('--component-select-popup-border-radius', /^\d/.test(c.select.popupBorderRadius) ? c.select.popupBorderRadius : `var(--radius-${c.select.popupBorderRadius})`);
...
function injectSelectComboboxVariables(root: HTMLElement, c: ComponentConfigSingle): void {
  root.style.setProperty('--component-select-combo-chip-bg', `rgb(${c.select.comboboxChipBackground})`);
  root.style.setProperty('--component-select-combo-chip-text', `rgb(${c.select.comboboxChipTextColor})`);
  root.style.setProperty('--component-select-combo-chip-radius', c.select.comboboxChipBorderRadius);
  root.style.setProperty('--component-select-combo-chip-close', `rgb(${c.select.comboboxChipCloseIconColor})`);
  root.style.setProperty('--component-select-combo-chip-close-size', c.select.comboboxChipCloseIconSize);
  root.style.setProperty('--component-select-combo-clear-bg', `rgb(${c.select.comboboxClearBackground})`);
  root.style.setProperty('--component-select-combo-clear-icon', `rgb(${c.select.comboboxClearIconColor})`);
  root.style.setProperty('--component-select-combo-clear-size', c.select.comboboxClearSize);
  root.style.setProperty('--component-select-combo-chip-font', c.select.comboboxChipFontSize);
  root.style.setProperty('--component-select-combo-selected-row-bg', `rgb(${c.select.comboboxSelectedRowBackground})`);
  root.style.setProperty('--component-select-combo-checkbox-checked-bg', `rgb(${c.select.comboboxCheckboxCheckedBackground})`);
  root.style.setProperty('--component-select-combo-checkbox-border', `rgb(${c.select.comboboxCheckboxBorderColor})`);
}
