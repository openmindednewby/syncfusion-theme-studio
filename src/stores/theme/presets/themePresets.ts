...
export const themePresets: ThemePreset[] = [
  ...
  { id: 'themeStudio', name: 'Theme Studio', description: 'SIEM dashboard with cyan accents and deep navy', previewColors: previewColors(THEMESTUDIO_THEME), theme: THEMESTUDIO_THEME },
