...
export const THEMESTUDIO_THEME: ThemeConfig = {
  id: 'themeStudio',
  name: 'Theme Studio',
  primary: THEMESTUDIO_PRIMARY,
  secondary: THEMESTUDIO_SECONDARY,
  neutral: THEMESTUDIO_NEUTRAL,
  status: THEMESTUDIO_STATUS,
  ...
  light: THEMESTUDIO_LIGHT_MODE,
  dark: THEMESTUDIO_DARK_MODE,
  components: THEMESTUDIO_COMPONENTS,
