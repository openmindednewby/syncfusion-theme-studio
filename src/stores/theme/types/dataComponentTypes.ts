...
export interface DataGridConfig {
  ...
  groupDropAreaTextColor: string;
  groupDropAreaBorderColor: string;
  groupChipBackground: string;
  groupChipTextColor: string;
  ...
  selectionBarChipBackground: string;
  selectionBarChipTextColor: string;
  selectionBarClearBackground: string;
  selectionBarClearTextColor: string;
  radioColor: string;
}
