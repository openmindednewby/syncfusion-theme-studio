...
export interface SelectConfig {
  ...
  /** Combobox chip background color (RGB triplet) */
  comboboxChipBackground: string;
  /** Combobox chip text color (RGB triplet) */
  comboboxChipTextColor: string;
  /** Combobox chip border radius */
  comboboxChipBorderRadius: string;
  /** Combobox chip close icon color (RGB triplet) */
  comboboxChipCloseIconColor: string;
  /** Combobox chip close icon size (e.g. '16px') */
  comboboxChipCloseIconSize: string;
  /** Combobox clear-all button background (RGB triplet) */
  comboboxClearBackground: string;
  /** Combobox clear-all button icon color (RGB triplet) */
  comboboxClearIconColor: string;
  /** Combobox clear-all button size (e.g. '18px') */
  comboboxClearSize: string;
  /** Combobox chip font size */
  comboboxChipFontSize: string;
  /** Combobox selected row background (RGB triplet) */
  comboboxSelectedRowBackground: string;
  /** Combobox checkbox background when checked (RGB triplet) */
  comboboxCheckboxCheckedBackground: string;
  /** Combobox checkbox border color (RGB triplet) */
  comboboxCheckboxBorderColor: string;
}

export type { DatePickerConfig } from './datePickerConfig';
