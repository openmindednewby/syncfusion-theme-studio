...
import type { GridButtonVariant } from './gridButtonVariant';
...
export interface ThemeState {
  ...
  updatePillBadgeConfig: (updates: Partial<PillBadgeConfig>) => void;
  ...
  updateGridButtonsConfig: (updates: Partial<GridButtonsConfig>) => void;
  updateGridButtonVariant: (variant: GridButtonVariant, updates: Partial<GridButtonStateColors>) => void;
  updateGridDropdownConfig: (updates: Partial<GridDropdownConfig>) => void;
  ...
  updateInputMessageConfig: (updates: Partial<InputMessageConfig>) => void;
  updateSearchPanelConfig: (updates: Partial<SearchPanelConfig>) => void;
  updateLoaderConfig: (updates: Partial<LoaderConfig>) => void;
  updateSkeletonLoaderConfig: (updates: Partial<SkeletonLoaderConfig>) => void;
  updateSliderConfig: (updates: Partial<SliderConfig>) => void;
