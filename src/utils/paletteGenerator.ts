 ...
 * Light mode: bg='500', hover='600' (darken on hover). Dark mode: bg='500', hover='400' (lighten on hover).
 */
export function generateDerivedColors(primaryPalette: ColorScale, isLightMode: boolean): DerivedComponentColors {
  return {
    buttons: {
      primary: {
        background: primaryPalette['500'],
        backgroundHover: isLightMode ? primaryPalette['600'] : primaryPalette['400'],
